...
//  2025-01-21: Removed ImGui_ImplSDL2_SetGamepadMode().
...
static ImGuiKey ImGui_ImplSDL2_GameControllerButtonToImGuiKey(SDL_GameControllerButton button)
{
    switch (button)
    {
...
bool ImGui_ImplSDL2_ProcessEvent(const SDL_Event* event)
{
    ...
    switch (event->type)
    {
        ...
        case SDL_KEYUP:
        {
            ...
            io.SetKeyEventNativeData(key,
                                     static_cast<int>(event->key.keysym.sym),
                                     static_cast<int>(event->key.keysym.scancode),
                                     static_cast<int>(event->key.keysym.scancode)); // To support legacy indexing (<1.87 user code). Legacy backend uses SDLK_*** as indices to IsKeyXXX() functions.
            return true;
        }
        ...
        case SDL_CONTROLLERBUTTONUP:
        {
            ...
            io.AddKeyEvent(ImGui_ImplSDL2_GameControllerButtonToImGuiKey(static_cast<SDL_GameControllerButton>(event->cbutton.button)),
...
void ImGui_ImplSDL2_NewFrame()
{
    ...
    // Clear ImGuiBackendFlags_HasGamepad if no controllers exist.
