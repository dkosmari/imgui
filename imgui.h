...
struct ImFontAtlas
{
    ...
    IMGUI_API static const ImWchar*    GetGlyphRangesGreek();                  // Default + Greek and Coptic
    IMGUI_API static const ImWchar*    GetGlyphRangesKorean();                 // Default + Korean characters
    IMGUI_API static const ImWchar*    GetGlyphRangesJapanese();               // Default + Hiragana, Katakana, Half-Width, Selection of 2999 Ideographs
